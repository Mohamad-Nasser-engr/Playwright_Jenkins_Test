...
public class FileUploadTest {
    ...
    public void testFileUpload() throws IOException {
        // URL for the file upload API endpoint
        ...
        body.append("--" + boundary + "\r\n");
        body.append("Content-Disposition: form-data; name=\"file\"; filename=\"" + filePath.getFileName() + "\"\r\n");
        body.append("Content-Type: application/octet-stream\r\n\r\n");  // MIME type for binary data
        body.append(new String(fileContent, StandardCharsets.UTF_8));  // This is the file content in binary form
        body.append("\r\n");
        body.append("--" + boundary + "--\r\n");
        ...
        APIResponse response = requestContext.post(uploadApiUrl, RequestOptions.create()
                .setHeader("Content-Type", "multipart/form-data; boundary=" + boundary)
                .setData(bodyBytes));
